...
import './App.css'
import AddPoints from './pages/AddPoints.tsx'
import FontSettings from './pages/FontSettings.tsx'
import PointWidget from './pages/PointWidget.tsx'
import SetPoints from './pages/SetPoints.tsx'
import Streamlabs from './pages/Streamlabs.tsx'
...
function App() {
  ...
  switch(window.location.pathname) {
    ...
    case "/pointwidget":
      ...
      break
    case "/streamlabs":
      component = <Streamlabs />
      break  
  }
  var setDate = new Date("Jan 5, 2024 15:37:25")

  var countDownDate = setDate.getTime();
  
  function changeDate(date: number) {
      let newDate: number = setDate.getTime()
      newDate -= date
